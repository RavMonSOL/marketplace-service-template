...
app.get('/', (c) => c.json({
  ...
  endpoints: [
    ...
    { method: 'GET', path: '/api/x/search', description: 'X/Twitter Real-Time Search API — search tweets by keyword', price: '0.02 USDC' },
    { method: 'GET', path: '/api/x/trending', description: 'X/Twitter trending topics by region', price: '0.01 USDC' },
    { method: 'GET', path: '/api/x/user/:handle', description: 'X/Twitter user profile lookup', price: '0.01 USDC' },
    { method: 'GET', path: '/api/x/user/:handle/tweets', description: 'X/Twitter user recent tweets', price: '0.01 USDC' },
    { method: 'GET', path: '/api/x/thread/:tweet_id', description: 'X/Twitter thread/conversation fetch', price: '0.02 USDC' },
  ],
  pricing: {
